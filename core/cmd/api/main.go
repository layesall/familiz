...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		// CONTRIBUTIONS (anciennement /transactions)
		r.Post("/contributions", contributions.CreateContributionHandler)
		r.Get("/contributions", contributions.ListContributionsHandler)
		r.Put("/contributions/{id}", contributions.UpdateContributionHandler)
		r.Delete("/contributions/{id}", contributions.DeleteContributionHandler)
